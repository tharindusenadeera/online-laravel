            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ route('stripe.payment') }}" method="post" class="validation"
                                                    ...
                                                    data-stripe-publishable-key="pk_test_51JQjZpBWE2OUZhePaXHsHIiaBpsX9O1Ac7ERqDoJIv23CuxaXUoQDiUMfJ3PYAtZK4weC8YQb7t1VK5Nys4BNW7h00HBIWfbGj"
                                                    id="payment-form">
                        @csrf
...
<input  name="order_id" type='hidden' value="5">
                        <div class='form-row row'>
